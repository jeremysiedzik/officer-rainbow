 ...
 * and then starts the IntentService {@code com.robotagrex.or.alarm.SampleSchedulingService} to do some work.
 */
public class NotifyAlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void cancelAlarm(Context context) {
        ...
        // Disable {@code com.robotagrex.or.alarm.SampleBootReceiver} so that it doesn't automatically restart the
